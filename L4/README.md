...
&emsp; Сначала запускаем сервер [`srv.cpp`](https://github.com/t-chakir/chakir/blob/main/L4/srv/srv.cpp) на одном терминале, через [`./srv.sh`](https://github.com/t-chakir/chakir/blob/main/L4/srv/srv.sh). Затем клиента [`client.cpp`](https://github.com/t-chakir/chakir/blob/main/L4/client/client.cpp) на другом терминале, через [`./client.sh`](https://github.com/t-chakir/chakir/blob/main/L4/client/client.sh).
